...
images:
  - "/images/projects/project-02/hero-thermostat.png"
team:
  - name: "Samuel Garijo"
    role: "UI Designer"
...
The interface was selected by Renesas as their primary showcase for the EK-RA8D1 + Zephyr RTOS integration at Embedded World 2025, reaching 15,000+ industry professionals. Senior executives personally demonstrated the design in official company videos, validating its effectiveness as a technical showcase.

**Key Outcomes:**
- Delivered pixel-perfect interface optimized for embedded memory constraints
- Established custom typography standards for non-standard displays using human factors research
- Created reusable design methodology for embedded UI development where traditional guidelines don't apply
